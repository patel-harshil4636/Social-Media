...
var require_is_prop_valid_motion = __commonJS({
  "optional-peer-dep:__vite-optional-peer-dep:@emotion/is-prop-valid:motion"() {
    throw new Error(
      `Could not resolve "@emotion/is-prop-valid" imported by "motion". Is it installed?`,
    );
  },
});
...
function usePresence() {
  ...
  const safeToRemove = (0, import_react2.useCallback)(
...
function useVisualElement(
  ...
  var _a, _b;
  const { visualElement: parent } = (0, import_react10.useContext)(
    MotionContext,
  );
  ...
  const reducedMotionConfig = (0, import_react10.useContext)(
    MotionConfigContext,
  ).reducedMotion;
  ...
  const initialLayoutGroupConfig = (0, import_react10.useContext)(
  ...
  const wantsHandoff = (0, import_react10.useRef)(
...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(
    props,
    (0, import_react12.useContext)(MotionContext),
  );
...
function createRendererMotionComponent({
    ...
    return (0, import_jsx_runtime2.jsxs)(MotionContext.Provider, {
      ...
      children: [
        MeasureLayout2 && context.visualElement
          ? (0, import_jsx_runtime2.jsx)(MeasureLayout2, {
  ...
  const ForwardRefMotionComponent = (0, import_react13.forwardRef)(
    MotionComponent,
  );
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps =
      Component3 !== import_react18.Fragment
        ? { ...filteredProps, ...visualProps, ref }
        : {};
    const { children } = props;
    const renderedChildren = (0, import_react18.useMemo)(
...
function updateMotionValuesFromProps(element, next, prev) {
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(
          nextValue.version === "11.11.17",
          `Attempting to mix Motion versions ${nextValue.version} with 11.11.17 may not work as expected.`,
        );
      }
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  return (0, import_jsx_runtime3.jsx)(PopChildMeasure, {
    isPresent: isPresent2,
    childRef: ref,
    sizeRef: size,
...
var PresenceChild = ({
  ...
  const memoizedOnExitComplete = (0, import_react21.useCallback)(
    (childId) => {
  ...
  if (mode === "popLayout") {
    children = (0, import_jsx_runtime4.jsx)(PopChild, {
      isPresent: isPresent2,
      children,
    });
  }
  return (0, import_jsx_runtime4.jsx)(PresenceContext.Provider, {
    value: context,
    children,
  });
};
...
var AnimatePresence = ({
  ...
  const presentChildren = (0, import_react23.useMemo)(
  ...
  const [diffedChildren, setDiffedChildren] = (0, import_react23.useState)(
    presentChildren,
  );
  const [renderedChildren, setRenderedChildren] = (0, import_react23.useState)(
    presentChildren,
  );
  useIsomorphicLayoutEffect(() => {
...
function LazyMotion({ children, features, strict = false }) {
  ...
  return (0, import_jsx_runtime7.jsx)(LazyContext.Provider, {
...
function useForceUpdate() {
  ...
  import_react28.useState)(0);
  const forceRender = (0, import_react28.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react28.useCallback)(
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
  ...
  const deprecatedLayoutGroupContext = (0, import_react29.useContext)(
  ...
  return (0, import_jsx_runtime8.jsx)(LayoutGroupContext.Provider, {
